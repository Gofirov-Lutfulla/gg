...
// navbar actions and all section actions along with cube ratation when navbar is clicked
...
// portfalio section when clicking tab-list
...
// visibility for contant section when reloading (cube reloading animation)
setTimeout(() => {
...
document.getElementById('contact-form').addEventListener('submit', function(event) {
  ...
  emailjs.sendForm('service_mjx7ntl', 'template_ay8hhl4', this)
